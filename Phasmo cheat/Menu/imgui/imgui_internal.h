...
//#endif
    ...
    IMGUI_API bool          ButtonEx(const char* label, const float round, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          HotKeyEx(const char* label, bool* v, const ImVec2& size_arg, ImGuiButtonFlags flags);
