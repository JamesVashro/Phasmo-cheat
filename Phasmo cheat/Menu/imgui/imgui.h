...
namespace ImGui
{
    ...
    IMGUI_API bool          Button(const char* label, const float round, const ImVec2& size = ImVec2(0, 0));   // button
    IMGUI_API bool          HotKey(const char* label, bool* v, const ImVec2& size_arg = ImVec2(0, 0)); //HotKey
    ...
    IMGUI_API void          ImageRounded(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& tint_col, const ImVec4& border_col);
    ...
    IMGUI_API bool          SelectableCustom(const char* label, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0)); // "bool selected" carry the selection state (read-only). Selectable() is clicked is returns true so you can modify your selection state. size.x==0.0: use remaining width, size.x>0.0: specify width. size.y==0.0: use label height, size.y>0.0: specify height
    IMGUI_API bool          SelectableCustom(const char* label, bool* p_selected, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    // Widgets: List Boxes
